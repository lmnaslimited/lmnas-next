...
export function ProductCard({ step, title, subTitle, slug }) {
  return (
  ...
  return (
    ...
    <SectionContainer id={'products'}>
      ...
      <div className="grid gap-8 row-gap-5 md:row-gap-8 lg:grid-cols-3">
        ...
        <ProductCard step={'2'} slug={'e-commerce'} title={'Market 2 Order'} subTitle={'A blazing fast commerce platform with minimal design language for a greater shopping experience.'} />
